const Fee = [{ Fee: '0.01%' }, { Fee: '0.05%' }, { Fee: '0.3%' }, { Fee: '1%' }]
const Range = ['25%', '50%', '75%', 'Max']
const MORALIS_KEY =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJub25jZSI6IjNmNjMxNGRlLWU1OGEtNDQ5NC05MDRjLTgzMzlkNDcxZjEyYSIsIm9yZ0lkIjoiNDE3MzUwIiwidXNlcklkIjoiNDI5MDg4IiwidHlwZUlkIjoiNDU0ZjQzMTMtMjQ3Zi00MWQ4LTg1YTctZjE4ODEyMTVlZTRhIiwidHlwZSI6IlBST0pFQ1QiLCJpYXQiOjE3MzIzMTE5OTcsImV4cCI6NDg4ODA3MTk5N30.yfZMGunNmU9xTHbLg-3ce5um5h8GNiW1SqkTzbdSfPc'
const Tokens = {
  tokens: [
    {
      chainId: 1,
...
export default { Fee, Range, MORALIS_KEY, Tokens }
