...
function Homepage() {
  ...
  const handleAddLiquidity = async () => {
    ...
    // const tx111 = await routerContract.createAndInitializePoolIfNecessary(
    //   address1,
    //   address2,
    //   fee,
    //   BigInt(sqrtPrice)
    ...
    const desiredAmount = BigInt(Number(amount) * 10 ** selectedToken.decimals);
    const params2 = [
      {
        token0: address1,
        token1: address2,
    ...
    // const tx222 = await routerContract.mint(params2);
    // await tx222.wait();
